...
void VulkanDevice::CommandBeginLabel(const std::string& name, VkCommandBuffer commandBuffer, const glm::vec4& color)
{
...
void VulkanDevice::CommandEndLabel(VkCommandBuffer commandBuffer)
{
